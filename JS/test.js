...
var Intro = ["とっても運気の高いあなたのラッキーお菓子は「ポッキー」。みんなと一緒に「シェアハピ」すれば、さらにハッピーになれるかも…", "あなたのラッキーお菓子は「ばかうけ」。あなたの渾身のギャグもみんなに　ば・か・う・け　するかも…", "さらに幸せな１日を過ごしたい…そんなあなたのラッキーお菓子は「ハイチュウpremium」。これを食べれば“premium”な１日になるかも…", "あなたのラッキーお菓子は「駄菓子」。こども時代を思い出しながら、初心にかえってみてはいかが…？", "今日は最悪…そんな予感がするあなたのラッキーお菓子は「カラムーチョ」。辛（つら）さを“辛（から）さ”に変えて消化してしまいましょう…。", ];
